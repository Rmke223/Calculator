...
function init() {
    ...
    display.setAttribute("class", "col-12 border text-right");
    ...
    const fullClearBTN = makeElement("button", "col-6 border", "fullClearBTN", "C");
    fullClearBTN.setAttribute("onclick", "fullClear();");
    topRow.appendChild(fullClearBTN);
    const backBTN = makeElement("button", "col-3 border", "backBTN", "Back");
    backBTN.setAttribute("onclick", "back();");
    topRow.appendChild(backBTN);
    const divBTN = makeElement("button", "col-3 border", "/", "/");
    ...
    const zeroBTN = makeElement("button", "col-6 border", "0", "0");
    zeroBTN.setAttribute("onclick", "numbers(this.id);");
    bottomRow.appendChild(zeroBTN);
    const decimalBTN = makeElement("button", "col-3 border", ".", ".");
    decimalBTN.setAttribute("onclick", "numbers(this.id);");
    bottomRow.appendChild(decimalBTN);
    const equalBTN = makeElement("button", "col-3 border", "equalBTN", "=");
